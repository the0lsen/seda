...
def _convert_inputs(Lbol, eLbol, R, eR):
    """
    Convert user observables to grid interpolation-axis units for Monte Carlo sampling.

    Users pass Lbol in L_sun and R in R_jup. Returns centers and Gaussian sigmas on
